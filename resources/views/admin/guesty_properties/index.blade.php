    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          @php 
            $addbar=["name"=>$name,"add-data"=>false,"add-name"=>"Add ". Str::singular($name),"add-anchor"=>route($route.'.create')  ,"booking-cron-job"=>true ,"property-cron-job"=>true,"get-reviews-data"=>true,"set-token"=>true,"set-booking-token"=>true];
          @endphp
                ...
                <tbody>
                    ...
                    @foreach($data as $client)
                        <tr>
                            ...
                            <td>{{ App\Models\Location::find($client->sub_location_id)->name ?? '' }}</td>
