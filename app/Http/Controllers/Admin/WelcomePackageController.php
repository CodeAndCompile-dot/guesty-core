...
class WelcomePackageController extends Controller
{
    ...
    protected string $routeIndex = 'welcome_packages.index';

    protected string $viewPrefix = 'admin.welcome_packages';

    protected array $imageFields = [
        'image' => 'welcome_packages',
        'bannerImage' => 'welcome_packages',
    ];

    public function __construct(UploadService $uploadService)
    {
        $this->service = new CrudService(
            GenericCrudRepository::for(WelcomePackage::class),
            $uploadService,
        );
    }
    ...
    public function index()
    {
        return view("{$this->viewPrefix}.index", [
            'data' => WelcomePackage::orderBy('id', 'desc')->get(),
        ]);
    }
