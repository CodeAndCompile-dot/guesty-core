...
class OurClientController extends Controller
{
    ...
    protected string $routeIndex = 'our-clients.index';

    protected string $viewPrefix = 'admin.our-clients';

    protected array $imageFields = [
        'image' => 'our-clients',
        'bannerImage' => 'our-clients',
    ];

    public function __construct(UploadService $uploadService)
    {
        $this->service = new CrudService(
            GenericCrudRepository::for(OurClient::class),
            $uploadService,
        );
    }
